...
@Component({
  ...
  template: `
    ...
    >
      <nav class="flex items-center justify-between rounded-full bg-[#101014] px-8 py-3 shadow-[0_20px_45px_rgba(0,0,0,0.4)]">
        <a
        ...
        <a
          ...
          class="flex h-11 w-11 items-center justify-center rounded-full active:scale-90 transition {{ active() === 'lists' ? 'bg-[#ff5c00] text-white' : 'text-[#9a9aa0]' }}"
        >
        ...
        <a
          ...
          aria-label="Usuarios"
          class="flex h-11 w-11 items-center justify-center rounded-full active:scale-90 transition {{ active() === 'users' ? 'bg-[#ff5c00] text-white' : 'text-[#9a9aa0]' }}"
        >
