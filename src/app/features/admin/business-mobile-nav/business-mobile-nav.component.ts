...
@Component({
  ...
  template: `
    ...
    >
      <nav class="flex items-center justify-between rounded-full border border-stone-200 bg-white/95 px-5 py-3 shadow-[0_20px_45px_rgba(0,0,0,0.12)] backdrop-blur">
        <a
        ...
        <a
          ...
          aria-label="Pedidos"
          class="flex h-11 w-11 items-center justify-center rounded-full active:scale-90 transition {{ active() === 'orders' ? 'bg-[#ff5c00] text-white' : 'text-stone-400 hover:bg-stone-100' }}"
        >
        ...
        <a
          ...
          class="flex h-11 w-11 items-center justify-center rounded-full active:scale-90 transition {{ active() === 'products' ? 'bg-[#ff5c00] text-white' : 'text-stone-400 hover:bg-stone-100' }}"
        >
        ...
        @if (isAdmin()) {
          <a
            ...
            class="flex h-11 w-11 items-center justify-center rounded-full active:scale-90 transition {{ active() === 'qr' ? 'bg-[#ff5c00] text-white' : 'text-stone-400 hover:bg-stone-100' }}"
          >
          ...
          <a
            ...
            aria-label="Mesas"
            class="flex h-11 w-11 items-center justify-center rounded-full active:scale-90 transition text-stone-400 hover:bg-stone-100"
          >
        ...
        <button
          ...
          class="flex h-11 w-11 items-center justify-center rounded-full text-stone-400 hover:bg-stone-100 active:scale-90 transition"
        >
